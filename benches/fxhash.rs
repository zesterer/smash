...
#[inline(always)]
fn new_hashmap() -> fxhash::FxHashMap<u32, u32> {
    fxhash::FxHashMap::<u32, u32>::default()
}
...
#[bench]
fn perf_fxhash_construct(b: &mut Bencher) {
    b.iter(|| black_box(new_hashmap()));
}

#[bench]
fn perf_fxhash_insert(b: &mut Bencher) {
...
#[bench]
fn perf_fxhash_get(b: &mut Bencher) {
    let mut hm = new_hashmap();
    let set = new_random_set(10000);
